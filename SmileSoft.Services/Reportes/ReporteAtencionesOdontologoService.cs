...
{
    public class ReporteAtencionesOdontologoService : IReporteService<ReporteAtencionesOdontologoRequestDTO>
    {
        public byte[] GenerarReporte(ReporteAtencionesOdontologoRequestDTO request)
        {
            ...
            var todasLasAtenciones = atencionRepository.GetAllByRango(fecha, fechaFin)
        ...
        public Task<byte[]> GenerarReporteAsync(ReporteAtencionesOdontologoRequestDTO request)
        {
